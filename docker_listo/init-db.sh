...
docker exec -i add-dbms mysql -u root -pCHANGE_ME_ROOT_PASSWORD < ../data/database.sql

# Cargar datos
echo "Cargando inserts..."
docker exec -i add-dbms mysql -u root -pCHANGE_ME_ROOT_PASSWORD < ../data/inserts.sql
